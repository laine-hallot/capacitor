...
async function loadConfig() {
    ...
    const workspacesSetup = await (async () => {
        var _a;
        if ((0, monorepotools_1.isMonorepo)(appRootDir) && conf.extConfig.workspaces === 'npm') {
            const { fileType, path: rootOfMonorepo } = (0, monorepotools_1.findMonorepoRoot)(appRootDir);
            if (fileType === 'yaml') {
                return undefined;
            }
            const pkgJSONOfMonorepoRoot = await (0, fn_1.tryFn)(utils_fs_1.readJSON, (0, path_1.resolve)(rootOfMonorepo, 'package.json'));
            const workspaces = (_a = pkgJSONOfMonorepoRoot === null || pkgJSONOfMonorepoRoot === void 0 ? void 0 : pkgJSONOfMonorepoRoot.workspaces) !== null && _a !== void 0 ? _a : [];
            return {
